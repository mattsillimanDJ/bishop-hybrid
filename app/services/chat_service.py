...
def get_base_system_prompt() -> str:
    return (
        ...
        "Do not end responses with weak permission-based offers like 'If you want, I can...', "
        "'If you’d like...', 'Let me know if...', or 'Would you like me to...'. "
        "Prefer a concrete next action, a short 'Next move:' line, or no follow-up line. "
